...
classdef contourMultiLines < handle
    properties
    ...
    methods
        function obj = contourMultiLines (mat, gridCoordinates)
        ...
        function t = radDecrRearr (obj, mi)
            ...
            if mi<=obj.areas(1)
                ...
                reverseAreas = zeros(obj.numberOfLevels);
                I=1:obj.numberOfLevels;
                reverseAreas(I)=Areas(obj.numberOfLevels - I+1);
